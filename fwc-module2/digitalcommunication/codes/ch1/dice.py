...
plt.stem(n,panal, markerfmt='r',use_line_collection=True, label='Analysis')
plt.xlabel('$n$')
plt.ylabel('$p_{X}(n)$')
plt.legend()
plt.grid()# minor

plt.savefig('../../figs/chapter1/pmf.pdf')
plt.savefig('../../figs/chapter1/pmf.png')

#If using termux
#subprocess.run(shlex.split("termux-open ../../figs/chapter1/pmf.pdf"))
#else
plt.show()
